        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">ระบบจัดการรายการจัดส่ง-ทำรายการใหม่</li>
                </ol>
            </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row mb-2">
                    ...
                    <div class="col-lg-4">
                        <div class="text-lg-right">
                            <a href="{{ url('/order-edit') }}" class="btn btn-success btn-rounded"><i class="mdi mdi-basket mr-1"></i> เพิ่มรายการใหม่</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-centered mb-0">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('/order-receipt') }}" class="action-icon"> <i class="mdi mdi-eye"></i></a>
                                <a href="{{ url('/order-edit') }}" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
                                <a href="javascript:void(0);" class="action-icon" data-toggle="modal" data-target="#order-remove-modal">
                ...
                <!-- modal content -->
                <div id="order-remove-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="danger-header-modalLabel" aria-hidden="true">
                    @include('dashboard.order-remove')
                </div>
                <!-- /.modal -->
            </div>
        </div>
